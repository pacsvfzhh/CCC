/*
  # Fix Column Ambiguity in Employee Login Summary

  Fixes the is_active column ambiguity by explicitly qualifying column references.
*/
...
DECLARE
  v_admin_role text;
BEGIN
  -- Get admin role (explicitly qualify is_active)
